...
unsigned long global_dirtyable_memory(void)
{
	...
	x = global_page_state(NR_FREE_PAGES) + global_reclaimable_pages() - dirty_balance_reserve;
...
static unsigned long zone_dirtyable_memory(struct zone *zone)
{
	 ...
	 */
	return zone_page_state(zone, NR_FREE_PAGES) + zone_reclaimable_pages(zone) - zone->dirty_balance_reserve;
}
