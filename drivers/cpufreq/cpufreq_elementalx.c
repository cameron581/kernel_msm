...
int set_two_phase_freq_ex(int cpufreq)
{
	int i  = 0;
	for ( i = 0 ; i < NR_CPUS; i++)
...
void set_two_phase_freq_by_cpu_ex ( int cpu_nr, int cpufreq){
	two_phase_freq_array[cpu_nr-1] = cpufreq;
}

int input_event_boosted_ex(void)
{
	unsigned long flags;
...
int set_input_event_min_freq_ex(int cpufreq)
{
	int i  = 0;
	for ( i = 0 ; i < NR_CPUS; i++)
...
void set_input_event_min_freq_by_cpu_ex ( int cpu_nr, int cpufreq){
				   ...
				   unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		set_two_phase_freq_ex(1574000);
	        set_input_event_min_freq_by_cpu_ex(1, 1190000);
        	set_input_event_min_freq_by_cpu_ex(2, 1036000);
        	set_input_event_min_freq_by_cpu_ex(3, 729000);
        	set_input_event_min_freq_by_cpu_ex(4, 729000);
		if (dbs_enable == 1) {
